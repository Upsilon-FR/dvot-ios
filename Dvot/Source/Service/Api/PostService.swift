...
class PostService {
    static let POST_BASE = ApiServices.API_URL + "/ios/post"

    class func list(offset: Int, completion: @escaping (ApiResponse) -> Void) {
        guard let url = URL(string: PostService.POST_BASE + "/list/15/\(offset)") else {
